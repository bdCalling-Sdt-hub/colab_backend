...
//   const storage = multer.diskStorage({
//     destination: function (req, file, cb) {
//       // Get the user ID from the request (assuming it is available after authentication)
//       const userId = req.user?.id; // Ensure 'user' is available in req after authentication

//       let uploadPath = `uploads/users/${userId}`; // Dynamically set path based on user_id

//       // Set path based on the fieldname
//       if (file.fieldname === 'profile_image') {
//         uploadPath += '/profile';
//       } else if (file.fieldname === 'category_image') {
//         uploadPath += '/category';
...
//         uploadPath += '/videos';
//       } else if (file.fieldname === 'chat_images') {
//         uploadPath += '/chat_images';
//       } else if (file.fieldname === 'chat_videos') {
//         uploadPath += '/chat_videos';
//       } else if (file.fieldname === 'team_logo') {
//         uploadPath += '/team_logo';
//       } else if (file.fieldname === 'team_bg_image') {
//         uploadPath += '/team_bg_image';
//       } else if (file.fieldname === 'player_image') {
//         uploadPath += '/player_image';
//       } else if (file.fieldname === 'player_bg_image') {
//         uploadPath += '/player_bg_image';
//       } else if (file.fieldname === 'reward_image') {
//         uploadPath += '/reward_image';
//       } else if (file.fieldname === 'thumbnail') {
...
//       const name = `${userId || 'ieeiu'}-${Date.now()}-${file.originalname}`;
//       cb(null, name);
//     },
//   });
...
//       } else {
//         cb(new Error('Invalid file type')); // Reject invalid file types
//       }
//     } else {
//       cb(new Error('Invalid fieldname')); // Reject invalid fieldnames
//     }
//   };
...
//   return upload; // Return the multer upload middleware
// };
